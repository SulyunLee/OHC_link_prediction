...
Description:
    ...
    We use the following supervised approach: logistic regression
...
if __name__ == "__main__":
    ...
    df_precision_test.to_csv(write_folder / "precision_logit_week_{}_{}.csv".format(startweek, endweek))
    df_recall_test.to_csv(write_folder / "recall_logit_week_{}_{}.csv".format(startweek, endweek))
    ...
    for idx, k in enumerate(k_list):
        ...
        df.to_csv(write_folder / "top{}_precision_logit_week_{}_{}.csv".format(k, startweek, endweek))
        # ndcg
        df = pd.DataFrame(
        ...
        df.to_csv(write_folder / "top{}_ndcg_logit_week_{}_{}.csv".format(k, startweek, endweek))
